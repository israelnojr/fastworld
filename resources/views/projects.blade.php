                        ...
                        <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="section-header">
                                    <h2 class="pricing-title">Projetcs</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-10 col-md-offset-1">
                        <ul id="menu-pricing" class="menu-price">
                            @foreach($projects as $project)
                                <li class="item" id="{{ $project->slug }}">
                                    <a href="{{route('projects.show', $project->id)}}">
                                        <img src="{{ asset('uploads/project/'.$project->image) }}" class="img-responsive" alt="Product" style="height: 300px; width: 300px;" >
                                    </a>
                                    <h2 class="white">{{ $project->title }}</h2>
                                </li>
                            @endforeach
                        </ul>
                    </div>
